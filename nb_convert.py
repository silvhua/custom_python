...
def create_readme(filename, output_filename='README.md', figure_path='../outputs/figures/',
    ...
    result = export_notebook_to_md(
        ...
        collapse_codeblocks=collapse_codeblocks,
...
if __name__ == '__main__':
  ...
  file = '2023-07-04 portfolio notebook.ipynb'
  # response = export_notebook_to_md(file, 'README')

  result = create_readme(file, output_filename='testing', figure_path='', append_version=True)